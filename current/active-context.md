...
当前目标是收口 MNEMOSYNE-030 / MNEMOSYNE-030A / MNEMOSYNE-030C / MNEMOSYNE-030D / MNEMOSYNE-030E 的状态同步与索引补账：

- 用户 review research motivation；
- 用户 review current-research-prompts / report-topic-and-prompt-map；
- 用户 review current-report-summaries / 7 份 summaries；
- 人工复核 PDF 图表 / 图片 / 版式；
...
- `raw/research-reports/cycles/2026Q2-initial/research-cycle-origin-and-motivation.md` 已创建；
- `RC-2026Q2-initial` 研究动机已入库；
...
- report summaries / current-report-summaries / pdf-figure-review-index 已建立；
...
- 用户 review current-report-summaries / 7 份 summaries；
- 人工复核 PDF 图表 / 图片 / 版式；
- 根据复核结果更新 pdf-figure-review-index；
- 如果未来找回轻度研究 prompt，更新 research-prompt-index；
...
1. 用户 review research motivation、current-research-prompts、current-report-summaries；
