...
下一步应先进行 `notes/self-improvement-template-pack.md` 用户 review / 小修 template pack；随后转向目标项目 intake / memory system design spec 模板设计。
...
### MNEMOSYNE-026A / 026B：用户 review / 小修 template pack 与状态落账

目标：

- 同步 active-context / todo / candidate / decision / roadmap 状态；
- 修复 template pack 状态落账残留；
