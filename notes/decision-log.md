...
## DEC-0067
- 决策：建立 `raw/research-reports/` 研究轮次管理结构。
- 理由：研究报告具时效性，需按轮次保存并可追溯比较。
- 状态：accepted
- 来源引用：research-cycle-setup-2026Q2

## DEC-0068
- 决策：初始轮次设为 `RC-2026Q2-initial`，状态 `awaiting_original_reports`。
- 理由：先建立证据基线与目录，再导入 7 份原始报告。
- 状态：accepted
- 来源引用：raw/research-reports/cycles/2026Q2-initial/cycle-manifest.md

## DEC-0069
- 决策：研究报告是证据层，不是执行源。
- 理由：执行更新仍需用户确认并经 human-approved-spec 生效。
- 状态：accepted
- 来源引用：raw/research-reports/README.md

## DEC-0070
- 决策：旧研究证据不删除，允许标记 superseded / deprecated / confirmed。
- 理由：保留历史可支持迁移复审、差异解释与审计。
- 状态：accepted
- 来源引用：raw/research-reports/current/research-refresh-policy.md

## DEC-0071
- 决策：默认每三个月可 refresh，并支持 ad-hoc research cycle。
- 理由：兼顾固定节奏更新与突发专题研究需求。
- 状态：accepted
- 来源引用：raw/research-reports/current/research-refresh-policy.md
