...
- 决策：创建 `handoff/startup-instructions.md` 作为新会话和新 Codex 任务的固定启动说明。
- 理由：当前已有执行源、active-context、handoff 和研究证据入口，但需要一个稳定文件告诉新任务如何读取仓库并接手。
- 状态：accepted
- 来源：RAW-0020；RAW-0021

## DEC-0024

- 决策：`startup-instructions` 不是执行源。
- 理由：启动说明只规定接手流程，执行原则仍应由 `current/human-approved-spec.md` 统一管理。
- 状态：accepted
- 来源：RAW-0020；RAW-0021
...
- 决策：`startup-instructions` 同时服务新 ChatGPT 对话和新 Codex Cloud 任务。
- 理由：用户需要在普通对话窗口和 Codex Cloud 任务之间切换，并保持统一接手流程。
- 状态：accepted
- 来源：RAW-0020；RAW-0021

## DEC-0026

- 决策：涉及能力边界、新机制设计、平台适配、自动化可行性或目标项目记忆系统设计时，启动流程必须读取研究证据 current 视图。
- 理由：7 份研究报告是当前高权重证据层，可降低平台能力误判和过度自动化承诺。
- 状态：accepted
- 来源：RAW-0020；RAW-0021
...
- 决策：MNEMOSYNE-020 完成后，下一步应进行接手演练。
- 理由：需要验证仓库文件是否足以让新 ChatGPT / 新 Codex 任务接手当前工作，而不是依赖当前对话上下文。
- 状态：accepted
- 来源：RAW-0020；RAW-0021
