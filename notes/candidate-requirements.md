...
- 内容：接手演练通过后，active-context、handoff-current、todo、open-questions 和 v0.1 consistency check 应同步到“v0.1 可接手，等待用户 review 和 v0.2 方向选择”状态。
- 状态：reflected
- 来源：RAW-0021B
- 反映位置：current/active-context.md；handoff/handoff-current.md；current/todo.md；current/open-questions.md；notes/v0.1-scope-and-consistency-check.md

## CAND-0024

- 内容：startup-rehearsal-report 作为接手演练结果记录，不是执行源，但可作为判断 v0.1 接手链路是否可用的证据。
- 状态：reflected
- 来源：RAW-0021B
- 反映位置：notes/startup-rehearsal-report.md；handoff/handoff-current.md

## CAND-0025

- 内容：v0.2 第一方向应由用户在 review v0.1 状态后选择。
- 状态：pending
- 来源：RAW-0021B
- 反映位置：current/open-questions.md；current/todo.md
