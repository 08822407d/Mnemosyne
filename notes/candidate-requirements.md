...
## CAND-0037
- 标题：完成 v0.1 接手层强制覆盖修复
- 状态：reflected
- 说明：必须把接手修复从“声明完成”变为“文件实际完成”。
- 来源引用：RAW-0018
- 已反映位置：active-context / handoff / todo / v0.1-scope-check

## CAND-0038
- 标题：active-context 进入“已完成接手修复”状态
- 状态：reflected
- 说明：active-context 不应继续包含“下一步执行 v0.1 接手能力修复”。
- 来源引用：RAW-0018
- 已反映位置：active-context

## CAND-0039
- 标题：handoff-current 必须为新会话可读接手卡
- 状态：reflected
- 说明：handoff 需提供执行源边界、读取顺序与下一步动作。
- 来源引用：RAW-0018
- 已反映位置：handoff

## CAND-0040
- 标题：TODO 移除 v0.1 接手修复未完成项
- 状态：reflected
- 说明：`current/todo.md` 不应再列出“执行 v0.1 接手能力修复与当前状态同步”。
- 来源引用：RAW-0018
- 已反映位置：todo

## CAND-0041
- 标题：v0.1 scope 检查必须与实际文件一致
- 状态：reflected
- 说明：scope 检查文档不得出现“文档未改却标记完成”的状态漂移。
- 来源引用：RAW-0018
- 已反映位置：v0.1-scope-check

## CAND-0042
- 标题：本次涉及文件恢复正常 Markdown 换行
- 状态：reflected
- 说明：标题、段落、列表需可读，避免单行压缩影响接手。
- 来源引用：RAW-0018
- 已反映位置：human-approved-spec / active-context / handoff / todo / open-questions / notes
