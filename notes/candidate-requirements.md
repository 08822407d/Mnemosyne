...
## CAND-0081
- 标题：研究报告应按 research cycle 保存，禁止覆盖旧轮次
- 状态：reflected
- 说明：研究证据具有时效性，应以轮次追加方式管理历史。
- 来源引用：raw/research-reports/README.md
- 是否已反映到相关文件：是（raw/research-reports/README.md）

## CAND-0082
- 标题：建立初始研究轮次 RC-2026Q2-initial
- 状态：reflected
- 说明：作为初始证据基线，等待 7 份原始研究报告导入。
- 来源引用：raw/research-reports/cycles/2026Q2-initial/cycle-manifest.md
- 是否已反映到相关文件：是（cycle-manifest 与 active-context/handoff）

## CAND-0083
- 标题：研究刷新默认季度节奏并支持 ad-hoc 轮次
- 状态：reflected
- 说明：默认每三个月 refresh，遇新问题可按需创建专题轮次。
- 来源引用：raw/research-reports/current/research-refresh-policy.md
- 是否已反映到相关文件：是（research-refresh-policy.md）

## CAND-0084
- 标题：研究报告变化需通过 delta report 比较后再影响实施版
- 状态：pending
- 说明：研究变化先进入证据比较与用户确认，不能直接改执行源。
- 来源引用：raw/research-reports/current/research-refresh-policy.md
- 是否已反映到相关文件：部分（policy 已反映，delta 模板待建）

## CAND-0085
- 标题：研究报告不是执行源
- 状态：reflected
- 说明：研究证据仅支持决策，不可直接替代 human-approved-spec。
- 来源引用：raw/research-reports/README.md
- 是否已反映到相关文件：是（README 与相关 current 文件）
