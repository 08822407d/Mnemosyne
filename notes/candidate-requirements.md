...
- 内容：Codex Task Result Record 默认占位符路径必须统一为 `notes/codex-task-results/TASK_ID-result.md`。
- 状态：reflected
- 来源：RAW-0030
- 反映位置：notes/self-improvement-workflow.md；notes/system-construction-baseline.md；current/todo.md；notes/codex-task-results/MNEMOSYNE-025G-result.md
...
- 状态：reflected
- 来源：RAW-0030
- 反映位置：notes/codex-task-results/MNEMOSYNE-025H-result.md

## CAND-0065

- 内容：为避免尖括号被 Markdown、HTML、工具或模型错误处理，不再使用 `<TASK_ID>` 作为默认占位符。
- 状态：reflected
- 来源：RAW-0030
- 反映位置：notes/self-improvement-workflow.md；notes/system-construction-baseline.md；notes/decision-log.md
...
- 内容：进入 MNEMOSYNE-026 前至少要完成路径占位符规范化。
- 状态：reflected
- 来源：RAW-0030
- 反映位置：current/todo.md；current/active-context.md；handoff/handoff-current.md
...
- 内容：缺失 TASK_ID 的旧路径是错误路径，不应继续出现在当前规范文件中。
- 状态：reflected
- 来源：MNEMOSYNE-025I
- 反映位置：notes/codex-task-results/MNEMOSYNE-025I-result.md

## CAND-0070

- 内容：为避免尖括号被 Markdown、HTML、工具或模型错误处理，不再使用尖括号 TASK_ID 作为默认占位符。
- 状态：reflected
- 来源：MNEMOSYNE-025I
- 反映位置：notes/self-improvement-workflow.md；notes/decision-log.md
...
- 内容：进入 MNEMOSYNE-026 前至少要完成路径规范化。
- 状态：reflected
- 来源：MNEMOSYNE-025I
- 反映位置：current/todo.md；current/active-context.md；handoff/handoff-current.md
